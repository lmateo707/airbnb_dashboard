...
def pricesummary(neighborhood):
    ...
    listings_data_grouped = listings_data.loc[(listings_data["neighbourhood_cleansed"]== neighborhood),:]
...
def bedroomssummary(neighborhood):
    ...
    # Ensure neighborhood column is equal to the chosen neighborhood (in the path)
    listings_data_grouped_2 = listings_data_2.loc[(listings_data_2["neighbourhood_cleansed"]== neighborhood),:]
...
def bathroomssummary(neighborhood):
    ...
    # Ensure neighborhood column is equal to the chosen neighborhood (in the path)
    listings_data_grouped_3 = listings_data_3.loc[(listings_data_3["neighbourhood_cleansed"]== neighborhood),:]
...
def pricelist(neighborhood):
    ...
    # Ensure neighborhood column is equal to the chosen neighborhood (in the path)
    listings_data_grouped_4 = listings_data_4.loc[(listings_data_4["neighbourhood_cleansed"] == neighborhood),:]
...
def reviewscorelist(neighborhood):
    ...
    # Ensure neighborhood column is equal to the chosen neighborhood (in the path)
    listings_data_grouped_5 = listings_data_5.loc[(listings_data_5["neighbourhood_cleansed"] == neighborhood),:]
...
def property_type(neighborhood):
    ...
    # Ensure neighborhood column is equal to the chosen neighborhood (in the path)
    listings_data_grouped_6 = listings_data_6.loc[(listings_data_6["neighbourhood_cleansed"] == neighborhood),:]
...
def room_type(neighborhood):
    ...
    # Ensure neighborhood column is equal to the chosen neighborhood (in the path)
    listings_data_grouped_7 = listings_data_7.loc[(listings_data_7["neighbourhood_cleansed"] == neighborhood),:]
...
def cancellation_policy(neighborhood):
    ...
    # Ensure neighborhood column is equal to the chosen neighborhood (in the path)
    listings_data_grouped_8 = listings_data_8.loc[(listings_data_8["neighbourhood_cleansed"] == neighborhood),:]
...
def bedtype(neighborhood):
    ...
    # Ensure neighborhood column is equal to the chosen neighborhood (in the path)
    listings_data_grouped_9 = listings_data_9.loc[(listings_data_9["neighbourhood_cleansed"] == neighborhood),:]
...
def reviewcontentlist(neighborhood):
    ...
    # Ensure neighborhood column is equal to the chosen neighborhood (in the path)
    reviews_content_data_grouped = reviews_content_data.loc[(reviews_content_data["neighbourhood_cleansed"] == neighborhood),:]
...
def superhost(neighborhood):
    ...
    # Ensure neighborhood column is equal to the chosen neighborhood (in the path)
    superhost_data_grouped = superhost_data.loc[(superhost_data["neighbourhood_cleansed"] == neighborhood),:]
...
def identityverfified(neighborhood):
    ...
    # Ensure neighborhood column is equal to the chosen neighborhood (in the path)
    identityverfified_data_grouped = identityverfified_data.loc[(identityverfified_data["neighbourhood_cleansed"] == neighborhood),:]
...
def listingscount(neighborhood):
    ...
    # Ensure neighborhood column is equal to the chosen neighborhood (in the path)
    listingscount_data_grouped = listingscount_data.loc[(listingscount_data["neighbourhood_cleansed"] == neighborhood),:]
